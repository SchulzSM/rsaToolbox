...
event_listString=[event_listString;{'rsaToolbox v2.0.0'}];
	...
	% Otherwise construct the fullfilename and Check and load the file.
		...
		if ~isempty(str2num(save_intercept)) & ~isempty(str2num(save_B))
			...
			if (fid < 0)
				...
				fprintf(fid,'%s\n',char('rsaToolbox v2.0.0 by Stefan M. Schulz <schulz@psychologie.uni-wuerzburg.de> - regression parameters'));
				global infantOption;
				if infantOption==1
...
% handles	structure with handles and user data (see GUIDATA)
	...
	if isequal([fileName,pathName],[0,0])
		...
		if (fid < 0)
			...
			event_listString=[event_listString;{'______________________________________________________________________'}];
			fprintf(fid,'%s\n',char(['rsaToolbox v2.0.0 by Stefan M. Schulz <schulz@psychologie.uni-wuerzburg.de> - event monitor output']));
			global infantOption;
			if infantOption==1
				fprintf(fid,'%s\n',char(['Note: infant option is',char(9),'on']));
			else
...
% handles	structure with handles and user data (see GUIDATA)
	...
	if sTemp(1,2)>0
		...
		if (fid < 0)
			...
			fprintf(fid,'%s\n',char('rsaToolbox v2.0.0 by Stefan M. Schulz <schulz@psychologie.uni-wuerzburg.de> - RSA data output - one column per data set'));
			global infantOption;
			if infantOption==1
				fprintf(fid,'%s\n',char(['Note: infant option is',char(9),'on']));
			else
...
% handles	structure with handles and user data (see GUIDATA)
	...
	if sTemp(1,2)>0
		...
		if (fid < 0)
			...
			fprintf(fid,'%s\n',char('rsaToolbox v2.0.0 by Stefan M. Schulz <schulz@psychologie.uni-wuerzburg.de> - RSA/VT data output - one column per data set'));
			global infantOption;
			if infantOption==1
				 fprintf(fid,'%s\n',char(['Note: infant option is',char(9),'on']));
			else
...
% handles	structure with handles and user data (see GUIDATA)
	...
	if sTemp(1,2)>0
		...
		if (fid < 0)
			...
			fprintf(fid,'%s\n',char('rsaToolbox v2.0.0 by Stefan M. Schulz <schulz@psychologie.uni-wuerzburg.de> - TTOT-corrected RSA/VT data output - one column per data set'));
			global infantOption;
			if infantOption==1
				   fprintf(fid,'%s\n',char(['Note: infant option is',char(9),'on']));
			else
...
% handles	structure with handles and user data (see GUIDATA)
	...
	if cancelFlag==0
		...
		for j=1:d
			...
			if j == 1
				fprintf(fid,'%s\n',char(['rsaToolbox v2.0.0 by Stefan M. Schulz <schulz@psychologie.uni-wuerzburg.de> - Analysis:',char(9),datestr(now)]));
			...
			if j == 1
				fprintf(fid,'%s\n',char(['rsaToolbox v2.0.0 by Stefan M. Schulz <schulz@psychologie.uni-wuerzburg.de> - Analysis: ',datestr(now)]));
...
% handles	structure with handles and user data (see GUIDATA)
	...
	if cancelFlag==0
		...
		fprintf(fid,'%s\n',char('rsaToolbox v2.0.0 by Stefan M. Schulz <schulz@psychologie.uni-wuerzburg.de> - paced breathing RSA data output - one column per paced breathing data set'));
		global infantOption;
		if infantOption==1
			fprintf(fid,'%s\n',char(['Note: infant option is',char(9),'on']));
		else
		...
		fprintf(fid,'%s\n',char('rsaToolbox v2.0.0 by Stefan M. Schulz <schulz@psychologie.uni-wuerzburg.de> - paced breathing RSA/VT data output - one column per paced breathing data set'));
		global infantOption;
		if infantOption==1
			fprintf(fid,'%s\n',char(['Note: infant option is',char(9),'on']));
		else
	...
	if isequal([fileName,pathName],[0,0])
		...
		for j=1:length(batchList)
			...
			if j==1
				...
				fprintf(fid,'%s\n',char(['rsaToolbox v2.0.0 by Stefan M. Schulz <schulz@psychologie.uni-wuerzburg.de> - VivoLogic',char(174),' data import:',char(9),datestr(now)]));
				fprintf(fid,'%s\t','data folder');
				if noOfFilenameElements>0
					fprintf(fid,'%s\t','dataset');
					for nFilenameElements=1:noOfFilenameElements+1
...
% handles	structure with handles and user data (see GUIDATA)
	...
	if isequal([fileName,pathName],[0,0])
		...
		for j=1:length(batchList)
			...
			if j==1
				fid = fopen([pathName,'data_generated_for_rsaToolbox\description.txt'],'a');
				fprintf(fid,'%s\n',char(['rsaToolbox v2.0.0 by Stefan M. Schulz <schulz@psychologie.uni-wuerzburg.de> - VivoSense',char(174),' data import:',char(9),datestr(now)]));
				fprintf(fid,'%s\t','data folder');
				if noOfFilenameElements>0
					fprintf(fid,'%s\t','dataset');
					for nFilenameElements=1:noOfFilenameElements+1
