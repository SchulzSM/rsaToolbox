%strmult.m is part of the RSA calibration toolbox,
...
%
%strmult.m - part of rsaToolbox v2.0.2 - Copyright (C) 1999  Alexander Gerlach
%
...
%
%=====================================================
%function strnew=strmult(strold,x);
%
%Part of rsaToolbox - duplicates a string x times
%=====================================================
