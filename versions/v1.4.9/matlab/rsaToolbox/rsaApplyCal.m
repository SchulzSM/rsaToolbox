...
%
%rsaApplyCal.m - part of rsaToolbox v1.4.9 - Copyright (C) 2006  Stefan M. Schulz
%
...
function [RVExpPre,RVExpPreCutoff,RVExpDif,RVExpDifCutoff,TTOTExpCutoff,RVExpDifMean,RVExpDifCutoffMean]=rsaApplyCal(TTOTExp,RVExp,B,intercept,cutoff);
