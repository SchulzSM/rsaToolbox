...
%
%rsaClearFlag.m - part of rsaToolbox v1.4.9 - Copyright (C) 2008  Stefan M. Schulz
%
...
%includediffType=5: set data not meeting conservative PVC to zero and breth with < 2 IBI to missing
