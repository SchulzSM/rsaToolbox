...
This release provides a stable MATLAB-based implementation of rsaToolbox, including a compiled Windows executable.
...
* This version predates the 2.x series and represents an intermediate stable release.
